<%@ page import="java.util.*,com.src.model.*,com.src.dao.*,com.src.service.*" %>

<%
OrderDAO orderDao = new OrderDAOImpl();
OrderServiceInterface orderSer = new OrderServiceImpl();
ProductDAO productDao = new ProductDAOImpl();
List<Order> orders = orderSer.getAllOrders();
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    %>
        <div class="order-card">
            ...
            <div class="order-details">
                <p><strong>UserID:</strong> <%= o.getUserId() %></p>
